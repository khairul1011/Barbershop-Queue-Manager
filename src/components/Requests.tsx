            ...
            pendingRequests.map((req) => {
              ...
              return (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -50 }}
                  className="bg-card-bg border border-border-subtle hover:border-amber-500/10 rounded-2xl p-5 space-y-4 relative flex flex-col justify-between transition-all"
                >

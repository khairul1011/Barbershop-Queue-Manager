...
describe('dayToDate', () => {
  ...
  it('balikin tanggal LOKAL, bukan UTC -- kritis buat jam 00:00-06:59 WIB', () => {
  ...
  it('hari yang sama kayak hari ini -> tanggal hari ini', () => {
    const now = new Date(2026, 0, 15, 12, 0, 0); // Kamis, 15 Jan 2026
    vi.setSystemTime(now);
    expect(dayToDate('Thu')).toBe('2026-01-15');
  });

  it('hari minggu depan -> selalu maju (nggak pernah mundur ke masa lalu)', () => {
